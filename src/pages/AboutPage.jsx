...
const AboutPage = () => {
  return (
    ...
    <main className="bg-gradient-to-r from-indigo-50 to-blue-100 dark:from-gray-900 dark:to-blue-950 text-gray-900 dark:text-gray-100 font-sans transition-colors duration-300">
  {/* Hero Section */}
  <section className="px-6 md:px-16 py-20 md:py-28 flex flex-col items-center text-center">
    <h1 className="text-4xl md:text-6xl font-bold mb-6 text-blue-900 dark:text-blue-300">
      About Smart Learning System
    </h1>
    ...
    <div className="mt-12 w-full h-1 rounded-full bg-gradient-to-r from-blue-300 via-indigo-400 to-blue-300 dark:from-blue-700 dark:via-indigo-600 dark:to-blue-700 opacity-30" />
  </section>

  {/* Features Section */}
  <section className="px-6 md:px-16 py-16 bg-gradient-to-r from-blue-100 to-indigo-200 dark:from-gray-800 dark:to-gray-900 transition-colors duration-300">
    <h2 className="text-3xl md:text-4xl font-bold text-blue-900 dark:text-blue-300 mb-10 text-center">
      Key Features
    </h2>
    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
      {[
        ...
        <div key={idx} className="bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900 border border-transparent dark:border-gray-700 p-6 transition-colors duration-300">
  ...
  {/* Closing Section */}
  <section className="px-6 md:px-16 py-20 bg-white dark:bg-gray-900 text-center transition-colors duration-300">
  ...
  {/* Footer */}
  <footer className="px-6 md:px-16 py-8 text-center text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 transition-colors duration-300">
    © {new Date().getFullYear()} Learning Assistant. All rights reserved.
  </footer>
</main>
  );
